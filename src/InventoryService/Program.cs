...
/********************************************************/
// get the agentId and register the AIAgent services for the InventoryAgent
builder.Services.AddSingleton<AIAgent>(sp =>
{
    var agentId = AgentNamesProvider.GetAgentName(AgentNamesProvider.AgentName.InventoryAgent);
