...
/********************************************************/
// get the agentId and register the AIAgent services for the LocationServiceAgent
builder.Services.AddSingleton<AIAgent>(sp =>
{
    var agentId = AgentNamesProvider.GetAgentName(AgentNamesProvider.AgentName.LocationServiceAgent);
